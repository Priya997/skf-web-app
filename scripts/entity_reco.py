def entity_data():
   ...
   'Incorrect or missing charset':'Incorrect charset',
   'missing charset':'Incorrect or missing charset',
   ...
   'OCSP':'OCSP stapling',
   'Insecure communication':'Insecure internal communication',
   'OCSP stapling':'OCSP stapling',
   'Client side input validation':'Client side input validation',
   ...
   'Include anti':'Include anti',
   'Filename injection':'Filename injection Path traversel',
   'Path traversel':'Filename injection Path traversel',
   ...
   'Differential attack':'Differential analysis attack',
   'Differential analysis attack':'Differential analysis attack',
   ...
   'Log viewing software':'Log viewing software code injection',
   ...
   'Verbose error':'Verbose error messaging',
   'Verbose error message':'Verbose error messaging',
   'Verbose error messaging':'Verbose error messaging',
   'Segregated components':'Segregated components',
   ...
   'All connections should be TLS':'All connections should be TLS',
   'Debug enabeling':'Debug enabeling',
   'Screen scraping data harvest':'Screen scraping data harvest',
   'GET POST requests':'GET POST requests',
   'Logging guidelines':'Logging guidelines',
   'Cross origin resource sharing':'Cross origin resource sharing',
   'Character encoding':'Character encoding',
   'External DTD parsing':'External DTD parsing',
   ...
   'Forget password functions':'Forget password functions',
   'File':'File',
   'Log rotation and seperation':'Log rotation and seperation',
   ...
   'Password forget pattern':'Password forget pattern',
   'Repudiation':'Repudiation attack',
   ...
   'Regular expression injection':'Regular expression injection',
   'SSI':'SSI injections',
   'verbose authentication':'Too verbose authentication',
   'SSI injections':'SSI injections',
   'Too verbose authentication':'Too verbose authentication',
   ...
   'SOAP basic profile':'SOAP basic profile',
   ...
   'JSON XML':'JSON XML schema',
   'Resource identifier':'Resource identifier injection',
   'JSON XML schema':'JSON XML schema',
   'Resource identifier injection':'Resource identifier injection',
   ...
   'Identifier based authorization':'Identifier based authorization',
   'CSRF on REST':'CSRF on REST',
   ...
   'STRIDE':'STRIDE',
   'Identify all components':'Identify all components',
   ...
   'X Path':'X Path injections',
   'X Path injections':'X Path injections',
   'HSTS preload':'HSTS preload',
   'cross subdomain cookie attack':'cross subdomain cookie attack',
   ...
   'Submit forms pattern':'Submit forms pattern',
   ...
   'Access control pattern':'Access control pattern',
   'Distinguish log':'Distinguish log',
   'not available item':'not available item',
   ...
   'Insecure datastorage':'Insecure datastorage',
   'Logout structuring':'Logout structuring',
